...
var util         = require('util')
  ...
  , feature_flag = require(path.join(__dirname, 'feature_flags.js'))
...
function Config(config) {
  ...
  if(config.browser_monitoring&&config.browser_monitoring.beacon_host){
...
function initialize(config) {
   ...
   *
   * TODO: Find a way to do this that's not an antipattern.
   */
