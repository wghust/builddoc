  ...
  describe("_login", function () {
    ...
    describe("off the happy path", function () {
      ...
      describe("receiving InvalidLicenseKey after get_redirect_host", function () {
        ...
        var response = {
          exception : {
            message    : 'Invalid license key. Please contact support@oneapm.com.',
            error_type : 'OneAPM::Agent::LicenseException'
          }
        };
        ...
        it("should have included an informative error message", function () {
          expect(captured.message)
            .equal("Invalid license key. Please contact support@oneapm.com.");
        });

        it("should have included the OneAPM error class", function () {
          expect(captured.class).equal("OneAPM::Agent::LicenseException");
        });
    ...
    it("should discard InternalLimitExceeded exceptions", function (done) {
      var exception = {
        exception : {
          ...
          error_type : 'OneAPM::Agent::InternalLimitExceeded'
        }
      };
    ...
    it("should reconnect and resubmit on ForceRestartException", function (done) {
      var exception = {
        exception : {
          ...
          error_type : 'OneAPM::Agent::ForceRestartException'
        }
      };
      ...
      var redirect = nock(URL)
                       .post(generate('get_redirect_host'))
                       .reply(200, {return_value : "tpm.oneapm.com"});
      var connect = nock(URL)
                      .post(generate('connect'))
    ...
    it("should stop the agent on ForceDisconnectException", function (done) {
      var exception = {
        exception : {
          ...
          error_type : 'OneAPM::Agent::ForceDisconnectException'
        }
      };
      ...
      function tested(error) {
        ...
        expect(error.class).equal('OneAPM::Agent::ForceDisconnectException');
    ...
    it("should pass through maintenance notices", function (done) {
      var exception = {
        exception : {
          ...
          error_type : 'OneAPM::Agent::MaintenanceError'
        }
      };
      ...
      function tested(error) {
        ...
        expect(error.class).equal('OneAPM::Agent::MaintenanceError');
