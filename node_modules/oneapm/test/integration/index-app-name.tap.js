...
test("loading the application via index.js for an invalid app_name", function (t) {
  ...
  process.env.ONEAPM_HOME = path.join(__dirname, 'configs')
  process.env.ONEAPM_HOST = 'staging-tpm.oneapm.com';
  process.env.ONEAPM_LICENSE_KEY = 'd67afc830dab717fd163bfcb0b8b88423e9a1a3b';
