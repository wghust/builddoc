$(document).ready(function() {
    ...
    addBug.prototype = {
        _init: function() {
            for (var j = 0; j < $(".bugimageshow").length; j++) {
                var oneimage = {
                    name: $(".bugimageshow").eq(j).data('name'),
                    url: $(".bugimageshow").eq(j).attr('src'),
                    hash: $(".bugimageshow").eq(j).data('hash')
                };
